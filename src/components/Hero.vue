<template>
  <section class="px-5 md:px-[100px] mt-2.5 lg:mt-0 lg:grid lg:grid-cols-2 lg:gap-10 items-center">
    <div class="flex flex-col max-w-[530px] gap-4">
      ...
      <img src="/images/hero-illustration.png" alt="Luma Hero Illustration"
        class="lg:hidden block logo w-full h-auto" />
      <p class="max-w-[498px]">
        Luma helps businesses shine online through strategic innovation. <strong>Powered by Suggui</strong>, we deliver
        high-performance digital marketing solutions—from SEO to content creation—that ensure your brand stands out.
      </p>

      <a href="https://suggui.vercel.app/"
        class="flex justify-center items-center gap-2 max-w-[220px] text-center py-2 px-3 bg-white rounded-[14px] text-black">
        <svg class="drop-shadow-[0_0_30px_#008000]" stroke="#000" fill="#008000" stroke-width="1" viewBox="0 0 512 512" height="1em" width="1em"
    ...
    <img src="/images/hero-illustration.png" alt="Luma Hero Illustration" class="hidden lg:block logo w-full h-auto" />
  </section>
</template>